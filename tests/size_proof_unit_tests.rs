...
fn test_archive_size_proof_creation() {
    ...
    let root_hash = Hash::from_hex("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855").unwrap();
...
fn test_proof_compression() -> anyhow::Result<()> {
    let store_id = Hash::from_hex("a3f5c8d9e2b1f4a6c9d8e7f2a5b8c1d4e7f0a3b6c9d2e5f8b1c4d7e0a3b6c9d2")?;
    let root_hash = Hash::from_hex("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")?;
    ...
    let original_proof = ArchiveSizeProof {
        ...
        layer_size_tree_root: Hash::from_hex("1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef")?,
        integrity_proofs: IntegrityProofs {
            archive_header_hash: Hash::from_hex("abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890")?,
            layer_index_hash: Hash::from_hex("fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321")?,
            root_hash_verification: root_hash,
            first_layer_content_hash: Hash::from_hex("1111111111111111111111111111111111111111111111111111111111111111")?,
        },
    };
    ...
    assert_eq!(decompressed.verified_layer_count, original_proof.verified_layer_count);
    assert_eq!(decompressed.calculated_total_size, original_proof.calculated_total_size);
...
fn test_hex_encoding_decoding() -> anyhow::Result<()> {
    ...
    let proof = ArchiveSizeProof {
        ...
        layer_size_tree_root: Hash::from_hex("2222222222222222222222222222222222222222222222222222222222222222")?,
        integrity_proofs: IntegrityProofs {
            archive_header_hash: Hash::from_hex("3333333333333333333333333333333333333333333333333333333333333333")?,
            layer_index_hash: Hash::from_hex("4444444444444444444444444444444444444444444444444444444444444444")?,
            root_hash_verification: root_hash,
            first_layer_content_hash: Hash::from_hex("5555555555555555555555555555555555555555555555555555555555555555")?,
        },
    };
    ...
    assert_eq!(decoded_proof.verified_layer_count, proof.verified_layer_count);
    assert_eq!(decoded_proof.calculated_total_size, proof.calculated_total_size);
...
fn test_compression_effectiveness() -> anyhow::Result<()> {
    ...
    let proof = ArchiveSizeProof {
        ...
        layer_sizes,
        layer_size_tree_root: Hash::from_hex("6666666666666666666666666666666666666666666666666666666666666666")?,
        integrity_proofs: IntegrityProofs {
            archive_header_hash: Hash::from_hex("7777777777777777777777777777777777777777777777777777777777777777")?,
            layer_index_hash: Hash::from_hex("8888888888888888888888888888888888888888888888888888888888888888")?,
            root_hash_verification: root_hash,
            first_layer_content_hash: Hash::from_hex("9999999999999999999999999999999999999999999999999999999999999999")?,
        },
    };
    ...
    assert!(compression_ratio < 0.8, 
           ...
           compression_ratio * 100.0, compressed_size, json_size);
    
    // But should still be substantial (not over-compressed)
    assert!(compressed_size > 200, 
           "Compressed proof too small, might be missing data: {} bytes", compressed_size);
...
fn test_large_archive_proof() -> anyhow::Result<()> {
    ...
    let large_proof = ArchiveSizeProof {
        ...
        layer_sizes,
        layer_size_tree_root: Hash::from_hex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")?,
        integrity_proofs: IntegrityProofs {
            archive_header_hash: Hash::from_hex("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb")?,
            layer_index_hash: Hash::from_hex("cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc")?,
            root_hash_verification: root_hash,
            first_layer_content_hash: Hash::from_hex("dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd")?,
        },
    };
    ...
    assert!(hex_encoded.len() < 10000, 
           "Proof for 10GB archive should still be < 10KB, got {} bytes", hex_encoded.len());
...
fn test_thread_safety() -> anyhow::Result<()> {
    ...
    for result in &results[1..] {
        assert_eq!(result, first_result, "Thread safety violation: different results");
    }
