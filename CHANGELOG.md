...
### Build
- **publish:** Make the digstore workspace publishable to crates.io (#52)
...
### Build
- **digstore-chain:** Publish digstore-chain to crates.io (#50)

## [0.27.0] - 2026-08-22

### Features
- **ci:** Publish bare linux-arm64 digstore binaries (#48)

## [0.26.0] - 2026-08-22

### Build
- **digstore-chain:** Chia-wallet-sdk 0.30 -> 0.34 (#45)
...
### Bug Fixes
- **cli:** Default the origin to the local node, with a per-project override (#37)
...
### Bug Fixes
- **deps:** Bump wasmtime off the unpatched 45.x line (RUSTSEC-2026-0222) (#35)
